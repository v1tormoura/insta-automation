      ...
      >
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 14, padding: 18 }}>
          ...
          <div style={{ display: 'flex', gap: 8, paddingTop: 4 }}>
            <button type="button" className="btn-ghost" onClick={onClose} style={{ flex: 1, padding: '9px', borderRadius: 9, fontSize: '.85rem' }}>Cancelar</button>
            <button type="submit" className="btn-primary" disabled={saving} style={{ flex: 2, padding: '9px', borderRadius: 9, fontSize: '.85rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
