...
const card = {
  background: 'oklch(0.13 0.03 240 / 0.88)',
...
function InsightCard({ icon, title, value, sub, detail, color }) {
  return (
    <motion.div variants={fadeUp} whileHover={{ y:-3, boxShadow:`0 16px 44px rgba(0,0,0,.52), 0 0 0 1px ${color}25` }} transition={spring}
      style={{ background:'oklch(0.13 0.03 240 / 0.75)', border:`1px solid ${color}20`, borderRadius:16, padding:'16px 18px', display:'flex', flexDirection:'column', gap:10, position:'relative', overflow:'hidden' }}
      className="sheen">
      ...
      <main className="dashboard">
        ...
        <section className="quick-grid">
          {quickActions.map(({ title, subtitle, icon: Icon, to }, i) => (
            ...
            >
              <Link to={to} style={{ textDecoration:'none', display:'flex', alignItems:'center', gap:12, padding:'12px 14px', borderRadius:14, background:'oklch(0.13 0.03 240 / 0.88)', border:'1px solid oklch(1 0 0 / 0.07)', backdropFilter:'blur(14px)', cursor:'pointer', width:'100%', transition:'all .22s cubic-bezier(.4,0,.2,1)' }} className="sheen">
