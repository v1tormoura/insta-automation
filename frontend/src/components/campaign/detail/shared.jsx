...
export const STATUS_PUB = {
  pending:    { rotulo: 'Pendente',   cor: 'text-[var(--text3)]', badge: 'secondary',   Icone: Circle },
  scheduled:  { rotulo: 'Agendada',   cor: 'text-[var(--cyan)]',  badge: 'outline',     Icone: Clock },
  processing: { rotulo: 'Publicando', cor: 'text-[#60a5fa]',      badge: 'purple',      Icone: Loader2 },
  published:  { rotulo: 'Publicado',  cor: 'text-[var(--green)]', badge: 'success',     Icone: CheckCircle2 },
  failed:     { rotulo: 'Falhou',     cor: 'text-[var(--red)]',   badge: 'destructive', Icone: XCircle },
  cancelled:  { rotulo: 'Cancelada',  cor: 'text-[var(--text3)]', badge: 'secondary',   Icone: MinusCircle },
};

export const STATUS_COMENTARIO = {
  none:      { rotulo: 'Sem comentário',       cor: 'text-[var(--text3)]', badge: 'secondary' },
  scheduled: { rotulo: 'Comentário agendado',  cor: 'text-[var(--cyan)]',  badge: 'outline' },
  posted:    { rotulo: 'Comentado',            cor: 'text-[var(--green)]', badge: 'success' },
  failed:    { rotulo: 'Comentário falhou',    cor: 'text-[var(--red)]',   badge: 'destructive' },
  cancelled: { rotulo: 'Comentário cancelado', cor: 'text-[var(--text3)]', badge: 'secondary' },
};
...
export function ContaAvatar({ conta, size = 26 }) {
  ...
  return (
    <span
      className="relative inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full border border-[var(--border)] bg-[rgba(0,212,255,.1)] font-bold text-[var(--cyan)]"
...
export function ConteudoThumb({ conteudo, size = 30 }) {
  ...
  return (
    <span
      className="inline-flex shrink-0 items-center justify-center overflow-hidden rounded-[6px] border border-[var(--border)] bg-[rgba(255,255,255,.04)] font-mono font-bold text-[var(--text3)]"
...
export function Eyebrow({ children, className }) {
  return (
    <div className={cn('text-[9.5px] font-bold uppercase tracking-[.08em] text-[var(--text3)]', className)}>
      {children}
    </div>
  );
}
...
export function Vazio({ children, className }) {
  return (
    <div className={cn('py-8 text-center text-[11.5px] text-[var(--text3)]', className)}>
      {children}
    </div>
  );
}
